...
const AdminListRows = [
  { id: 1, FirstName: 'AdminSnow', SurName: 'Jon',userName:'xxx1', password:'admin',},
];
      ...
      <div className='AdminManagement-Con'>
        ...
        <div className='AdminManagementHeadButt-con'>
          <div className='AdminManagementButt-con'>
            <button type="button" className='SwapPageButt' onClick={()=>setNowPage((NowPage)=>'AdminList')}>Admin List</button>
            <button type="button" className='SwapPageButt' onClick={()=> setNowPage((NowPage)=>'AddAdmin')}>Add Admin</button>
          </div>
        </div>

...
const CourseRows = [
  { id: 1, OwnerName: 'CourseSnow', TitleName: 'Jon' },
];
const PostRows = [
      ...
      <div className='AdminManagement-Con'>
        <div className='AdminManagementHeadButt-con'>
          <div className='AdminManagementButt-con'>
            ...
            <button type="button" className='SwapPageButt' onClick={()=> setNowPage((NowPage)=>'Post')}>Post</button>
            <button type="button" className='SwapPageButt'onClick={()=> setNowPage((NowPage)=>'Report')}>Report</button>
          </div>
        </div>

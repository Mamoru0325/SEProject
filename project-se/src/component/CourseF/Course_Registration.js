...
const rows = [
    createData("India", "20-3-2023", "13:00:00", "16:00:00", 5000, "เสร็จสิ้น", "55"),
                            ...
                            <TableBody>
                                {rows.map((row) => (
                                    <TableRow key={row.id}>
                                        ...
                                        <TableCell align={"center"} style={{ color: "#003566" }}><NavLink to="/CoursePage" className={"buttonDetail"} ><IoIosEasel /></NavLink></TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
